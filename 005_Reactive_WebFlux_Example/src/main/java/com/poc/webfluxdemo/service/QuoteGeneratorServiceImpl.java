...
public class QuoteGeneratorServiceImpl implements QuoteGeneratorService {
	...
	private final MathContext mathContext = new MathContext(20);
	...
	public Flux<Quote> fetchQuoteStream(Duration period) {
		...
		.zipWith(Flux.interval(period)) //This creates a tupple.
		.map(t -> t.getT1())
		...
		.map(quote -> {
			...
			return quote;
		}).log("com.poc.webfluxdemo.service.QuoteGenerator");
	}
